  ...
  Widget _buildLoginCard() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: omanGreen.withOpacity(0.10), width: 1),
        boxShadow: [
          BoxShadow(
  ...
  Widget _buildLogo() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: omanGreen.withOpacity(0.12), width: 1),
        boxShadow: [
          BoxShadow(
            color: omanGreen.withOpacity(0.08),
            blurRadius: 16,
      ...
      child: ClipRRect(
        ...
        child: Image.asset(
          ...
          errorBuilder: (context, error, stackTrace) {
            return const Icon(Icons.store_rounded, size: 52, color: omanGreen);
          },
        ),
      ),
    );
  ...
  InputDecoration _inputDecoration({
    ...
    return InputDecoration(
      ...
      focusedBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(15),
        borderSide: const BorderSide(color: omanGreen, width: 1.5),
      ),
    );
  }
    ...
    messenger.showSnackBar(
      SnackBar(
        ...
        content: Container(
          ...
          decoration: BoxDecoration(
            color: isError ? const Color(0xff20242b) : omanDarkGreen,
